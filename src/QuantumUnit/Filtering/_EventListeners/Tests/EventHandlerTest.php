...
use QuantumUnit\Filters\EventListeners\EventHandler;
...
class EventHandlerTest extends \tests\BaseTest{
    ...
    public function testAddListener() {
        ...
        $listenerConfig = array('listener' => 'Gossamer\\Horus\\_EventListeners\\Tests\\TestListener', 'event' => 'request_start');
